...
export default function Profile() {
  ...
  // clicking the Update button updates current user in the server using the client.update function
  // when the server responds successfully, the currently logged in user's profile is updated
  const updateProfile = async () => {
    const updatedProfile = await client.updateUser(profile); // fetches user from client
  ...
  const signout = async () => {
    await client.signout(); // fetches null user object from client
